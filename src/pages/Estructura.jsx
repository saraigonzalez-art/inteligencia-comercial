    ...
    <div style={styles.page}>
      ...
      <div style={styles.container}>
        <section style={styles.hero}>
          ...
          <p style={styles.text}>
            Consulta los organigramas oficiales y revisa la distribución general de la estructura comercial.
            comercial.
          </p>

          <div style={styles.infoBox}>
            <h3 style={styles.infoHeading}>Reporte de Cambio de Estructura:</h3>
            <ul style={styles.infoList}>
              <li>
                Formulario creado para el reporte de cambios de director o jefe inmediato, cambios de localidad, asignación o eliminación de claves a promotores y cambios de cargo que no estén actualizados por Recursos Humanos.
              </li>
              <li>
                <strong>
                  Los cambios deben ser reportados los 3 primeros días hábiles de cada mes.
        ...
        <section style={styles.viewerShell}>
          <div style={styles.viewerHeader}>
            <div>
              ...
              <p style={styles.viewerNote}>
                Esta sección contiene los organigramas oficiales en formato PDF.
              </p>
            </div>
          ...
          <div style={styles.pdfWrapper}>
            <iframe
              src="/organigramas-estructura-comercial.pdf#view=FitH"
              title="Organigramas Oficiales"
